...
def main():
    file = open("ROM_distribution_modify.coe", "w")
    file.write("memory_initialization_radix=16;\n")
    file.write("memory_initialization_vector=\n")

    file_sim = open("ROM_distribution_modify_simplest.txt", "w")
    ...
    for block in range(NumBlk_weiaddr):
        for i in range(54):
            ...
            # file.write(    "00010001000100010001000100010001" + ",\n")
            # file_sim.write("00010001000100010001000100010001" + "\n")
    # Pad to 64
    for block in range(NumBlk_weiaddr):
        for i in range(10):
